...
public class FragmentVideo extends Fragment implements ExoPlayer.EventListener{

    public static final String TAG = FragmentVideo.class.getSimpleName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            description = bundle.getString(Constant.KEY_STEPS_DESC);
            url = bundle.getString(Constant.KEY_STEPS_URL);
            pane = bundle.getBoolean(Constant.KEY_PANE_VID);
            thumbnailImage = bundle.getString(Constant.THUMBNAIL_IMAGE);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            int placeHolderVisibility = savedInstanceState.getInt(Constant.KEY_VISIBILITY_PLACEHOLDER);
            Log.d(TAG, "Visiblity: " + placeHolderVisibility);
            placeHolderImage.setVisibility(placeHolderVisibility);
            int visibilityExo = savedInstanceState.getInt(Constant.KEY_VISIBILITY_EXO_PLAYER);
        ...
        if (url != null) {
            if (url.equals("")) {
                ...
                if (savedInstanceState != null) {
                    ...
                    positionPlayer = savedInstanceState.getLong(Constant.MEDIA_POS);
                }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(Constant.KEY_VISIBILITY_EXO_PLAYER, simpleExoPlayerView.getVisibility());
        outState.putInt(Constant.KEY_VISIBILITY_PLACEHOLDER, placeHolderImage.getVisibility());
        //Saving current Position before rotation
        outState.putLong(Constant.MEDIA_POS, positionPlayer);
